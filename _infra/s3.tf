...
resource "aws_s3_bucket_server_side_encryption_configuration" "jcazevedo_net" {
...
resource "aws_s3_bucket_server_side_encryption_configuration" "www_jcazevedo_net" {
  bucket = aws_s3_bucket.www_jcazevedo_net.id
